import{_ as n,c as a,o as p,a4 as l}from"./chunks/framework.C2Gk6cJW.js";const d=JSON.parse('{"title":"","description":"","frontmatter":{},"headers":[],"relativePath":"asp/asp.md","filePath":"asp/asp.md","lastUpdated":1755149145000}'),e={name:"asp/asp.md"};function i(c,s,t,o,r,w){return p(),a("div",null,s[0]||(s[0]=[l(`<div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>[ASP.NET MVC] 1. ASP.NET 소개 - .net Framework, .net Core</span></span>

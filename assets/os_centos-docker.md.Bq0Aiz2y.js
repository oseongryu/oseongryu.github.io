import{_ as n,c as a,o as e,a4 as p}from"./chunks/framework.BaYfB92R.js";const u=JSON.parse('{"title":"","description":"","frontmatter":{},"headers":[],"relativePath":"os/centos-docker.md","filePath":"os/centos-docker.md","lastUpdated":1746595356000}'),l={name:"os/centos-docker.md"};function t(o,s,c,i,r,d){return e(),a("div",null,s[0]||(s[0]=[p(`<h3 id="centos-docker" tabindex="-1">centos docker <a class="header-anchor" href="#centos-docker" aria-label="Permalink to &quot;centos docker&quot;">​</a></h3><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>docker cp centos-jekyll:/root/guide ~/git-personal</span></span>

import{_ as n,c as a,o as p,a4 as e}from"./chunks/framework.C2Gk6cJW.js";const d=JSON.parse('{"title":"","description":"","frontmatter":{},"headers":[],"relativePath":"cs/cs.md","filePath":"cs/cs.md","lastUpdated":1755615820000}'),l={name:"cs/cs.md"};function t(i,s,c,o,r,u){return p(),a("div",null,s[0]||(s[0]=[e(`<div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>##  C#  자바형태 줄 추가 나 c#형태 줄추가로 변경할 수 있음 (체크 전부 해제할경우 Java 형태 )</span></span>
